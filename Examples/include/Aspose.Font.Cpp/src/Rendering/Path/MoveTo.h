...
/// </summary>
class ASPOSE_FONT_SHARED_CLASS MoveTo : public Aspose::Font::RenderingPath::IPathSegment
{
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(MoveTo, CODEPORTING_ARGS(double x, double y));

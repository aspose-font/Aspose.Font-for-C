...
/// </summary>
class ASPOSE_FONT_SHARED_CLASS ClosePath : public Aspose::Font::RenderingPath::IPathSegment
{
...
public:
    ...
    /// </summary>
    /// <param name="matrix">Transformation transformation matrix.</param>
...
protected:
    ...
    /// <summary>
    /// Initializes new <see cref="ClosePath"></see> object.
    /// </summary>
